...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'car.count', 'team_member.count'],
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'contact_email', header: 'Contact Email', accessorKey: 'contact_email' },
    { id: 'contact_phone', header: 'Contact Phone', accessorKey: 'contact_phone' },
