      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['booking_status.contains'],
          ...params.filters,
        },
        'booking',
      ),
  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.start_date ? format(record?.start_date, 'dd-MM-yyyy') : '',
    },
    {
      id: 'end_date',
      header: 'End Date',
      accessorKey: 'end_date',
      cell: ({ row: { original: record } }: any) => (record?.end_date ? format(record?.end_date, 'dd-MM-yyyy') : ''),
    },
